...
footer .right-box .socials{
  margin-top: 50px;
}
footer .right-box .socials ul{
  display: flex;
}
footer .right-box .socials ul li{
  width: 24px; 
  height: 24px;
  list-style: none;
  margin: 0 10px;
}
footer .right-box .socials ul li a{
  color: white;
}
footer .right-box .socials ul li a i{
  display: inline-block;
  color: white;
  width: 40px; 
  height: 40px;
}
footer .right-box .socials ul li:hover a i{
